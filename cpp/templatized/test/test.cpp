...
void main()
{
	...
	std::cout << "2D OSN for " << N_VALUES << " values took " << std::chrono::duration<float>(end - start).count() << " seconds\n";
	...
	std::cout << "3D OSN for " << N_VALUES << " values took " << std::chrono::duration<float>(end - start).count() << " seconds\n";
